...
def reset_db():
	...
	if prompt_bool('Are you sure you want to lose all your data in "{}"'.format(current_app.config['SQLALCHEMY_DATABASE_URI'])):
		db.drop_all()
		db.create_all()
		print("Done")
...
def add_root_user(login, password):
	...
	from trader.user.models import Users, User_status, User_role
	from trader.extensions  import db
