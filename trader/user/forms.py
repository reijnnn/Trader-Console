...
class CreateUserForm(FlaskForm):
   ...
   def __init__(self, *args, **kwargs):
      ...
      self.role.choices   = [(role, role)     for role   in User_role.get_new_user_roles_list()]
      self.status.choices = [(status, status) for status in User_status.get_new_user_statuses_list()]
