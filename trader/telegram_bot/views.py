...
from ..extensions       import login_manager, csrf, db, telegram_bot
...
def monitor_telegram_bot(page):
	...
	return render_template('telegram_bot.html', notifications=notifications, pagination=pagination, bot_name=current_app.config['TELEGRAM_BOT_NAME'], status=telegram_bot.get_status(), thread_status=telegram_bot.get_thread_status())
